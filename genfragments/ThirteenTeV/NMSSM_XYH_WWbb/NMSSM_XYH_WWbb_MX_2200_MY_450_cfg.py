...
for YMass,nEvents in YMassAndEvents.items():
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/afs/cern.ch/user/l/lcorcodi/public/MC-production/genproductions/bin/MadGraph5_aMCatNLO//NMSSM_XYH_bbbb_MX_2200_MY_%i_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz' %(YMass)),
